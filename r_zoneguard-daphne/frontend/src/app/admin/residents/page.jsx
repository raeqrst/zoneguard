...
export default function AdminResidentsPage() {
  ...
  const fetchLiveResidents = async () => {
    ...
    try {
      ...
      if (selectedType && selectedType !== 'All Residents') url += `type=${encodeURIComponent(selectedType)}&`;
      ...
      if (data.success) {
        ...
        setStats(data.stats || { totalTenants: 0, totalHomeowners: 0 });
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              <input type="text" readOnly value={selectedResident.fullNamedb || selectedResident.name} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid #D1D5DB', backgroundColor: '#F9FAFB', fontSize: '14px', fontWeight: '600', color: '#1F2937' }} />
            </div>
            ...
            <div style={{ display: 'flex', gap: '15px', marginBottom: '15px' }}>
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: 'flex', border: '1px solid #D1D5DB', borderRadius: '6px', overflow: 'hidden', backgroundColor: '#F9FAFB' }}>
                  ...
                  <input type="text" readOnly value={selectedResident.phone || selectedResident.contactNumber} style={{ width: '100%', padding: '10px', border: 'none', backgroundColor: 'transparent', fontSize: '14px', outline: 'none' }} />
                </div>
              </div>
            </div>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <input type="text" readOnly value={selectedResident.email || selectedResident.emailAddress} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid #D1D5DB', backgroundColor: '#F9FAFB', fontSize: '14px', color: '#1F2937' }} />
            </div>
