...
// Helper function to correctly determine whether to display "Lot" or just the number
    ...
    const fetchTenants = async () => {
      ...
      try {
        ...
        if (data.success) {
          ...
          // Natural alphabetical sorting for multiple properties (e.g., 17A before 17B)
