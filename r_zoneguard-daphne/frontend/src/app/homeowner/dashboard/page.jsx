...
export default function HomeownerDashboardPage() {
  ...
  // We keep a tiny fetch here just to power the "Hello, Name!" title on the dashboard itself.
  useEffect(() => {
    const storedUserStr = localStorage.getItem('zoneguard_user');
    if (storedUserStr) {
      const parsedUser = JSON.parse(storedUserStr);
      setFirstName(parsedUser.first_name || parsedUser.firstName || 'Homeowner');
    }
  }, []);
          ...
          <div className="overview-row">
            ...
            <section className="dashboard-card overview-card">
              ...
              <div className="overview-body">
                ...
                <strong className="overview-number">5</strong>
              </div>
              <div className="overview-footer split">
                <div>
                  <span className="dot yellow"></span>
                  <span className="muted-text">2 Private</span>
                </div>
                <div>
                  <span className="dot yellow"></span>
          ...
          <section className="dashboard-card service-card">
            <div className="service-body">
              ...
              <div className="service-actions">
                ...
                <Link href="/homeowner/vehicle-sticker" className="service-btn">
            ...
            <div className="form-section">
              ...
              <div className="qr-container">
                <div className="qr-inner">
                  <div className="qr-placeholder">{Icons.qr}</div>
                </div>
