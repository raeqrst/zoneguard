...
export default function SidebarLayout({ children, menuItems, settingsPath, topbarContent }) {
        ...
        <div className="layout-wrapper">
            <div className="main-container">
                <aside className="sidebar">
                    ...
                    <div className="sidebar-footer">
                        ...
                        <button
                            ...
                            className={`nav-link ${pathname === settingsPath ? 'active' : ''}`}
                        >
                ...
                <main className="content-area">
                    {topbarContent && <header className="topbar">{topbarContent}</header>}
